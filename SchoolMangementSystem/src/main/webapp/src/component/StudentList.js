...
class StudentList extends Component {
  ...
  deleteStudent(key) {
    //console.log("student =>" + JSON.stringify(key));
    axios.post(`http://localhost:8084/deleteStudents`, key).then((res) => {
  ...
  approveStudent(key) {
    console.log("student =>" + JSON.stringify(key));
    axios.post(`http://localhost:8084/approveStudents`, key).then((res) => {
                ...
                <tr key={student.id}>
                  ...
                  <td>
                    <div className="btn-group">
                      ...
                      &nbsp;
                      <button
                        onClick={() => this.approveStudent(student.id)}
